...
struct _target {
    ...
    char    *logname;        /* if search() relocates target */
...
/*  Indicates that logging for this target has been activated. The log output
    will be collected in a file with name "targetname.log" */
# define     T_FLAG_LOGTOFILE    0x0800    /* LOGTOFILE applied */
