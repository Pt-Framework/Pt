 ...
 */
#ifndef Pt_SettingsBase_h
#define Pt_SettingsBase_h
...
namespace Pt {
    ...
    */
    ...
    /** @brief Store application settings.
        ...
        @ingroup Utilities
    */
    class PT_API SettingsBase : protected SerializationInfo
    {
        public:
            ...
            */
            ...
            public:
                ...
                */
                ...
                /** @brief Returns the parent element.*/
                ConstEntry parent() const
                {
                    if (!_si)
                        return ConstEntry();

                    return ConstEntry(_si->parent());
                }
        ...
        protected:
            ...
            */
            ...
            virtual void onLoad(std::basic_istream<Pt::Char>& is) = 0;

            virtual void onSave(std::basic_ostream<Pt::Char>& os) const = 0;
};
