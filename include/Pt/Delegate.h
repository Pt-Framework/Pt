...
namespace Pt {
    ...
    */
    template < typename R,
               typename A1,
               typename A2 >
    class Delegate<R, A1, A2, Pt::Void> : public DelegateBase
    {
        public:
            typedef Callable<R, A1, A2, Pt::Void> Callable;
    ...
    */
    template < typename R,
               typename A1 >
    class Delegate<R, A1, Pt::Void, Pt::Void> : public DelegateBase
    {
        public:
            typedef Callable<R, A1, Pt::Void, Pt::Void> Callable;
    ...
    */
    template < typename R >
    class Delegate<R, Pt::Void, Pt::Void, Pt::Void> : public DelegateBase
    {
        public:
            typedef Callable<R, Pt::Void, Pt::Void, Pt::Void> Callable;
