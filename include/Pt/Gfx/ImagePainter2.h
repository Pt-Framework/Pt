...
class PT_GFX_API ImagePainter2 : public Painter
{
    public:
        ...
        // NOTE: The points must move in counter-clockwise (CCW) direction or something wrong will be drawn!
        // NOTE: This version of the function is needed to properly draw the points generated by some type of path
    ...
    private:
        ...
        inline void deduplicateRoundedPointsF(std::vector<Point>& dst, const PointF* src, const size_t pointCount);
        inline void convertPointsToPointsF(std::vector<PointF>& dst, const Point* src, const size_t pointCount);
...
void ImagePainter2::deduplicateRoundedPointsF(std::vector<Point>& dst, const PointF* src, const size_t pointCount)
{
    // Check if there is no actual point
    if(!pointCount) return;
...
void ImagePainter2::convertPointsToPointsF(std::vector<PointF>& dst, const Point* src, const size_t pointCount)
{
