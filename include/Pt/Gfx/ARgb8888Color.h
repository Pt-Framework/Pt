...
namespace Pt {
	...
	namespace Gfx {
		...
		//!    Blue  : 0 to 255
		template <>
		class PT_GFX_API PT_PACKED BasicColor<ARgb8888> {
			public:
			...
			public:
				...
				//! Return the alpha component of this color (in range 0 to 255)
				...
				//! Set the alpha component of this color (in range 0 to 255)
