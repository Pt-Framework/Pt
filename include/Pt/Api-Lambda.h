...
#ifndef PT_API_LAMBDA_H
#define PT_API_LAMBDA_H
...
class LambdaSlot : public BasicSlot<R, ARGUMENTS>
{
    public:
...
LambdaSlot<L, R, A...> slot(L&& lambda);
...
*/
template <typename R, typename... A, typename L>
LambdaSlot<L, R, A...> slot(Connectable& context, L&& lambda);

} // namespace Pt

#endif // PT_API_LAMBDA_H