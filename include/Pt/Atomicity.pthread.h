 ...
 ***************************************************************************/
#ifndef PT_ATOMICINT_PTHREAD_H
#define PT_ATOMICINT_PTHREAD_H
...
inline volatile void* atomicCompareExchange(void* volatile& dest, void* exch, void* comp)
{
    volatile void* old;
...
template <typename T>
volatile T* atomicExchange(T* volatile& dest, T* exch)
{
    volatile void* ret;
