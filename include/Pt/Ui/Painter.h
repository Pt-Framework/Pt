...
#ifndef PT_UI_PAINTER_H
#define PT_UI_PAINTER_H
...
/**
  ...
  * with this color. When a Texture (Image) is specified as brush Texture, the interior of the rectangle
...
class PT_UI_API Painter
{
    public:						
        ...
        /**
          ...
          * @see setPen()
          */
        inline void drawCircle(const PointF& topLeft, size_t diameter)
        {
        ...
        /**
          ...
          * @see setBrush()
          */
        inline void fillCircle(const PointF& topLeft, size_t diameter)
        {
