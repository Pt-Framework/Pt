...
#ifndef PT_UI_BRUSH_H
#define PT_UI_BRUSH_H
...
class PT_UI_API Brush
{
  ...
  public:
    ...
    friend PT_UI_API bool operator==(const Brush& a, const Brush& b);
...
PT_UI_API void operator >>=( const SerializationInfo& si, Brush& x );

PT_UI_API void operator <<=( SerializationInfo& si, const Brush& x );
