 ...
 */
#ifndef PT_MEMORYBLOCK_H
#define PT_MEMORYBLOCK_H
...
/** 
 * @brief MemoryBlock
 * Contains info about each allocated MemoryBlock - which is a collection of
 * contiguous blocks.  Each block is the same size, as specified by the
 * PoolFactory.  The number of blocks in a MemoryBlock depends upon page size.
 ...
 * MemoryBlocks as needed without overhead.  The Init and Release functions do
 * what the default constructor and destructor would do.  A MemoryBlock is not in
 * a usable state after it is constructed and before calling Init.  Nor is
 * a MemoryBlock usable after Release is called, but before the destructor.
 ...
 * A MemoryBlock is corrupt if this singly-linked list has a loop or is shorter
...
class PT_API MemoryBlock
{
    ...
    public:
         ...
         * @param rhs MemoryBlock object to compare. 
         */
        ...
        /**
         * @brief Initializes a just-constructed MemoryBlock.
         * @param blockSize Number of bytes per block.
         * @param blocks Number of blocks per MemoryBlock.    
         */
        void init( std::size_t blockSize, Pt::uint8_t blocks );
    
        /** 
         * @brief Allocate a block within the MemoryBlock.  
         ...
         * @return Pointer to block within MemoryBlock.
         */
         void* allocate( std::size_t blockSize );
    
        /** 
         * @brief Deallocate a block within the MemoryBlock. 
         * Complexity is always O(1), and this will never throw.  
         *
         ...
         * and a call to hasBlock is done from within method findMemoryBlock.  
        ...
        /** 
         * @brief Resets the MemoryBlock back to pristine values. 
         ...
         * This assumes the MemoryBlock's data was already using Init.
         */
...
#ifndef NDEBUG
        /** 
         * @brief Determines if the MemoryBlock has been corrupted.
         * @param numBlocks Total # of blocks in the MemoryBlock.
         ...
         * @return True if MemoryBlock is corrupt.
         */
        ...
        /**
         * @brief Returns true if block at address P is inside this MemoryBlock.
         */
