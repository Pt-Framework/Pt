...
#ifndef Pt_Windows1252Codec_h
#define Pt_Windows1252Codec_h
...
/** @brief A codec for windows 1252 encoding.
    ...
    @ingroup Unicode
*/
class Windows1252Codec : public TextCodec<Char, char> 
{
    public:
        //! @brief Constructor.
...
//! @internal
inline Pt::Char fromCP1254(uint8_t n)
{
...
//! @internal
inline uint8_t toCP1254(Pt::Char ch)
{
