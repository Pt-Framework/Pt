...
/** @brief Exception during JSON processing.
*/
class PT_JSON_API JsonError : public std::runtime_error
{
    public:
...
/** @brief Indicates JSON syntax errors.
*/
class PT_JSON_API SyntaxError : public JsonError
{
    public:
