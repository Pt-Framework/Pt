...
#ifndef PT_JSONRPC_HTTPCLIENT_H
#define PT_JSONRPC_HTTPCLIENT_H
...
/** @brief A client for JSON-RPC 2.0 remote procedure calls via HTTP.
*/
class PT_JSONRPC_API HttpClient : public Client
                                , public Connectable
{
  public:
    /** @brief Constructor.
