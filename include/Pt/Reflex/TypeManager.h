...
class PT_REFLEX_API TypeManager
{
    ...
    public:
        ...
        void registerFunction(const char* name, R (*func)(As...));
...
template <typename R, typename... As>
inline void TypeManager::registerFunction(const char* name, R (*func)(As...))
{
    Function<R, As...>* fi = new Function<R, As...>(*this, name, func);
