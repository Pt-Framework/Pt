...
class ServiceProcedure
{
    public:
        ...
        virtual IDeserializer** beginCall(SerializationContext& context) = 0;

        virtual ISerializer* endCall(SerializationContext& context) = 0;
};
...
template < typename R,
           ...
           typename A1,
           typename A2>
SerializationContext BasicServiceProcedure<R, C, A1, A2,
                            Pt::Void,
                            Pt::Void,
                            Pt::Void> ::_context;
*/
...
template < typename R,
           class C>
class BasicServiceProcedure<R, C, Pt::Void,
                                  Pt::Void,
                                  Pt::Void,
                                  Pt::Void,
                                  Pt::Void> : public ServiceProcedure
