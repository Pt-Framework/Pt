...
{
    public:
        /** @brief Creates a visibility event for @a widget.
        */
        ...
        /** @brief Creates an event without an affected widget.
        */
        ShowEvent()
        : _widgetId_(0)
        , _widget(0)
        ...
        /** @brief Destroys the visibility event.
        */
        virtual ~ShowEvent()
        {
        }
        ...
        */
        ...
        /** @brief Returns the affected widget, or null.
        */
        Widget* widget() const
        {
            return _widget;
