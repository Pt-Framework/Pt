...
#ifndef Pt_Forms_WindowStateEvent_h
...
{
    public:
        /** @brief Creates a window state event for @a widget with @a state.
        */
        ...
        /** @brief Destroys the window state event.
        */
        ...
        */
        ...
        /** @brief Returns the window presentation state.
        */
        ...
        /** @brief Sets the window presentation state to @a state.
        */
