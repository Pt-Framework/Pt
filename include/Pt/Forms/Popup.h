...
class PT_FORMS_API Popup : public Window
{
    ...
    public:
        /** @brief Creates a detached borderless popup.
        */
        Popup();
        ...
        */
        ...
        /** @brief Relates this popup to @a anchor for popup input handling.
            ...
            Pointer and touch input that hits the anchor or one of its
            descendants is routed to the anchor instead of the popup. The
            anchor does not position or size the popup.
        */
