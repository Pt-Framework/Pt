...
{
    public:
        /** @brief Creates an event for pointer entry into @a widget.
        */
        ...
        */
        ...
        /** @brief Returns the ID of the widget entered by the pointer.
        */
        ...
        /** @brief Returns the widget entered by the pointer.
        */
        Widget* widget() const
        {
            return _widget;
