...
#ifndef PT_FORMS_API_BASICS_H
#define PT_FORMS_API_BASICS_H

/** @defgroup Pt-Forms-Basics Application Basics

    @brief The Forms application model.
    ...
    %Application is the root element of the hierarchy. It provides the main
    %Screen, which represents a display and owns its top-level %WindowManager.
    A %WindowManager can also be embedded in a %Workspace. Windows attach to a
    window manager; each window is a %Form that acts as the root of one control
    tree.

    The following diagram shows the inheritance hierarchy. It does not describe
    the runtime parent relationship between controls.
