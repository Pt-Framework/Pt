	...
	namespace Gfx {
		...
		class PT_API PT_PACKED Color<XRgb1555> {
			public:
				 ...
				 */
				inline Color<XRgb1555>()
				: _val(0x0000)
				{}

				/** @brief Copy constructor.
				 */
				inline Color<XRgb1555>(const Color<XRgb1555>& c)
				: _val(c._val)
				{}

				/** @brief Construct color using the given packed color constant.
				 */
				inline Color<XRgb1555>(uint16_t val)
				: _val(val)
				{}
				 ...
				 */
				inline const Color<XRgb1555>& operator=(const Color<XRgb1555>& c)
			...
			public:
				friend void toARgb(uint16_t& a, uint16_t& r, uint16_t& g, uint16_t& b, const Color<XRgb1555>& from);
				friend void fromARgb(Color<XRgb1555>& to, const uint16_t a, const uint16_t r, const uint16_t g, const uint16_t b);
				friend bool operator==(const Color<XRgb1555>& c1, const Color<XRgb1555>& c2);
				friend bool operator<(const Color<XRgb1555>& c1, const Color<XRgb1555>& c2);
				friend bool operator>(const Color<XRgb1555>& c1, const Color<XRgb1555>& c2);

				friend const Color<XRgb1555>& greyscale(Color<XRgb1555>& to, const Color<XRgb1555>& from);
		 ...
		 */
		inline const Color<XRgb1555>& greyscale(Color<XRgb1555>& to, const Color<XRgb1555>& from)
		{
