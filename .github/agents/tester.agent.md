---
name: "Tester"
description: "Use when adding, updating, building, or running Pt C++ unit tests."
...
4. Return the test command, exit code, and relevant failure details to the caller.
