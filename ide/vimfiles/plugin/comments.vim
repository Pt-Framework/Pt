...
noremap  <silent> <C-K><C-C> :call CommentLine()<CR>
" key-mappings for range comment lines in visual <Shift-V> mode
vnoremap <silent> <C-K><C-C> :call RangeCommentLine()<CR>
...
function! CommentLine()
  ...
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.h$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
