                 ...
                 , public Pt::System::Selectable
{
    public:
        ...
        // --- Internal helpers for sqlite::Statement async operations ---
        void      enqueueStmtExec(Statement& stmt);
        size_type completeStmtExec();
        void      enqueueStmtSelect(Statement& stmt);
    ...
    private:
        // Helpers: Connection is friend of Statement, nested task structs are not
        static size_type callStatementExecute(Statement& stmt);
        static Result    callStatementSelect(Statement& stmt);
