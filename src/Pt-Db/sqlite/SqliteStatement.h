...
#ifndef PT_DB_SQLITE_SQLITESTATEMENT_H
#define PT_DB_SQLITE_SQLITESTATEMENT_H
...
class SqliteStatement : public IStatement
{
    ...
    protected:
        virtual size_type onExecute();

        virtual void onBeginExec();

        virtual size_type onEndExec();

    protected:
        virtual Result onSelect();

        virtual Row onSelectRow();

        virtual Value onSelectValue();

        virtual void onBeginSelect();

        virtual Result onEndSelect();

    protected:
        virtual ICursor* onCreateCursor();
    ...
    private:
        ...
        SmartPtr<SqliteConnection, InternalRefCounted<SqliteConnection> > _conn;
...
#endif // PT_DB_SQLITE_SQLITESTATEMENT_H
