...
void ProgressBar::update()
{
	...
	painter.fillRect(Math::Rect(Math::Point(numberOfRects * _blockWidth + 2, 2),
	...
	{
	    painter.drawRect(Math::Rect(Math::Point(2 + _blockWidth * i, 2), Math::Size(_blockWidth + 1, size().height() - 4)));
	    painter.fillRect(Math::Rect(Math::Point(3 + _blockWidth * i, 3), Math::Size(_blockWidth - 1, size().height() - 6)));
	}
