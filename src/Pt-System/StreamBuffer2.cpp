...
namespace System {
    ...
    int StreamBuffer2::StreamBufferImpl::streamBufferSync(StreamBuffer2& sb)
    {
        typedef StreamBuffer2::traits_type traits_type;
        ...
        if(sb.pptr())
        {
            ...
            {
                const StreamBuffer2::int_type ch = sb.overflow(traits_type::eof());
    ...
    std::streambuf::int_type StreamBuffer2::StreamBufferImpl::streamBufferUnderflow(StreamBuffer2& sb)
    {
        typedef StreamBuffer2::traits_type traits_type;
    ...
    std::streambuf::int_type StreamBuffer2::StreamBufferImpl::streamBufferOverflow(StreamBuffer2& sb, std::streambuf::int_type ch)
    {
        typedef StreamBuffer2::traits_type traits_type;
