...
namespace {
    ...
    inline void printEntity(std::basic_ostream<Pt::Char>& os, const Pt::Char* p)
    {
        os << Pt::Char('&');
        while (*p)
            os << Pt::Char(*p++);
    ...
    inline void printEntity(Pt::String& str, const Pt::Char* p)
    {
        str += Pt::Char('&');
        while (*p)
            str+= Pt::Char(*p++);
...
const Pt::Char* EntityResolver::findEntity(Char ch) const
{
    ...
    if( rent[u].charValue == ch.value() )
        return rent[u].entity;
    
    if( rent[o].charValue == ch.value() )
        return rent[o].entity;
