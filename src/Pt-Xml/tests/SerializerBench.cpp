...
int main(int argc, char* argv[])
{
    try
    {
        ...
        Pt::Arg<unsigned> I(argc, argv, 'I', nn.get() );
        Pt::Arg<unsigned> D(argc, argv, 'D', nn.get() );
        Pt::Arg<unsigned> C(argc, argv, 'C', nn.get() );
        Pt::Arg<bool> fileoutput(argc, argv, 'f');

        std::cout << "benchmark xml serializer with " << I.get() << " int vector " << D.get() << " double vector and " << C.get() << " custom vector iterations\n\n"
                     "options:\n"
        ...
        benchVector<int>("int", I.get(), fileoutput.get() );
        benchVector<double>("double", D.get(), fileoutput.get() );
