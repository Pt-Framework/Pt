...
GfxModel::GfxModel()
: DefineProperty(Visible,true)
, DefineProperty(Font,Pt::Gfx::Font("",12))
, DefineProperty(Position, Pt::Gfx::PointF(0,0))
, DefineProperty(Size, Pt::Gfx::SizeF(10,10))
, DefineProperty(BackColor,Pt::Gfx::ARgbColor(237,237,237))
, DefineProperty(BackColorHightLight,Pt::Gfx::ARgbColor(200,200,200))
, DefineProperty(ForeColor, Pt::Gfx::ARgbColor(70,70,70))
, DefineProperty(BackgroundImage, Pt::Gfx::ARgbImage(16,16))
, DefineProperty(BackgroundImageLayout, ImageLayoutType::NoLayout)
, DefineProperty(Opacity,0)
, DefinePropertyDefault(TransparancyKey)
, DefinePropertyDefault(Pointer2DStatus)
, DefinePropertyDefault(KeyStatus)
, DefinePropertyDefault(CursorT)
, DefineProperty(TextAlign,TextAlignType::MidleCenter)
, DefineProperty(Focused, false)
, DefineProperty(AcceptFocus,true)
, DefineProperty(HighLight, false)
, DefineProperty(FocusedActionKey," ")
{
