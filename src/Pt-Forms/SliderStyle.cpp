...
bool SliderStyleOptions::hasOverrides() const
{
    return _overrides != 0;
}


std::size_t SliderStyleOptions::generation() const
{
    return _generation;
}


bool SliderStyleOptions::hasOverride(StyleOverride mask) const
{
    return (_overrides & mask) != 0;
}


void SliderStyleOptions::setOverride(StyleOverride mask)
{
    _overrides |= mask;
    ++_generation;
}
