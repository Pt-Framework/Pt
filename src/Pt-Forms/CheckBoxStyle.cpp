...
bool CheckBoxStyleOptions::hasOverrides() const
{
    return _overrides != 0;
}


std::size_t CheckBoxStyleOptions::generation() const
{
    return _generation;
}


bool CheckBoxStyleOptions::hasOverride(StyleOverride mask) const
{
    return (_overrides & mask) != 0;
}


void CheckBoxStyleOptions::setOverride(StyleOverride mask)
{
    _overrides |= mask;
    ++_generation;
}
