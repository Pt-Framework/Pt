...
#ifndef PT_FORMS_COCOA_COCOAGRAPHICSBACKEND_H
#define PT_FORMS_COCOA_COCOAGRAPHICSBACKEND_H
...
class CocoaGraphicsBackend : public GraphicsBackend
{
    public:
        IPixmapImpl* createPixmapImpl() override
        {
            return new CocoaPixmapImpl();
        }
        ...
        CGImageRef getCGImage(const Pixmap& pixmap) const
        {
            const CocoaPixmapImpl* impl = static_cast<const CocoaPixmapImpl*>(pixmap.impl());
            return impl->getCGImage();
        }
};
