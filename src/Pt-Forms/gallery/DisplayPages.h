...
#ifndef PT_FORMS_GALLERY_DISPLAYPAGES_H
#define PT_FORMS_GALLERY_DISPLAYPAGES_H
...
class LabelPage : public GalleryPage
{
    public:
        LabelPage();
...
class PanelPage : public GalleryPage
{
    public:
        PanelPage();
...
class ProgressBarPage : public GalleryPage
{
    public:
        ProgressBarPage();
