...
#ifndef PT_FORMS_GALLERY_BUTTONPAGES_H
#define PT_FORMS_GALLERY_BUTTONPAGES_H
...
class PushButtonPage : public GalleryPage
{
    public:
        PushButtonPage();
    ...
    private:
        FlowLayout _body;
        PushButton _defaultBtn;
        PushButton _toggleBtn;
        PushButton _flatBtn;
        PushButton _iconBtn;
        CheckBox   _enableBox;
        Key        _shortcut;
