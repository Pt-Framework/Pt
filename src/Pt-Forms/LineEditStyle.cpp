...
bool LineEditStyleOptions::hasOverrides() const
{
    return _overrides != 0;
}


std::size_t LineEditStyleOptions::generation() const
{
    return _generation;
}


bool LineEditStyleOptions::hasOverride(StyleOverride mask) const
{
    return (_overrides & mask) != 0;
}


void LineEditStyleOptions::setOverride(StyleOverride mask)
{
    _overrides |= mask;
    ++_generation;
}
