...
#ifndef PT_FORMS_DIRECT2D_GRAPHICSBACKEND_H
#define PT_FORMS_DIRECT2D_GRAPHICSBACKEND_H
...
class Direct2dGraphicsBackend : public GraphicsBackend
{
    public:
        IPixmapImpl* createPixmapImpl() override
        {
            return new Direct2dPixmapImpl();
        }
        ...
        ID2D1Bitmap1* bitmap(const Pixmap& pixmap) const
        {
            const Direct2dPixmapImpl* impl = static_cast<const Direct2dPixmapImpl*>(pixmap.impl());
            if( ! impl )
                return 0;
