...
class StyleOptionsTest : public Unit::TestSuite
{
    ...
    protected:
        void ConstructDefault()
        {
            ...
            PT_UNIT_ASSERT(options.get<BackgroundOption>() == 0);
            PT_UNIT_ASSERT(options.get<ForegroundOption>() == 0);
            PT_UNIT_ASSERT(options.get<ContourOption>() == 0);
            PT_UNIT_ASSERT(options.get<AccentColorOption>() == 0);
            PT_UNIT_ASSERT(options.get<ViewBackgroundOption>() == 0);
            PT_UNIT_ASSERT(options.get<HighlightColorOption>() == 0);
            PT_UNIT_ASSERT(options.get<HoverBackgroundOption>() == 0);
            PT_UNIT_ASSERT(options.get<TextBackgroundOption>() == 0);
            PT_UNIT_ASSERT(options.get<TextColorOption>() == 0);
            PT_UNIT_ASSERT(options.get<PlaceholderTextColorOption>() == 0);
            PT_UNIT_ASSERT(options.get<HighlightedTextColorOption>() == 0);
            PT_UNIT_ASSERT(options.get<AlternateViewBackgroundOption>() == 0);
            PT_UNIT_ASSERT(options.get<PopupBackgroundOption>() == 0);
            PT_UNIT_ASSERT(options.get<PopupTextColorOption>() == 0);
            PT_UNIT_ASSERT(options.get<FontOption>() == 0);
        }
        ...
        void FontPartial()
        {
            ...
            const FontOption* stored = options.get<FontOption>();
        ...
        void CopyAssign()
        {
            ...
            PT_UNIT_ASSERT(copy.get<BackgroundOption>() != 0);
            PT_UNIT_ASSERT(copy.get<BackgroundOption>()->value().color() ==
                           Gfx::Color(4, 5, 6));
            PT_UNIT_ASSERT(copy.get<FontOption>() != 0);
