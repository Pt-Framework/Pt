...
bool SpinBoxStyleOptions::hasOverrides() const
{
    return _overrides != 0;
}


std::size_t SpinBoxStyleOptions::generation() const
{
    return _generation;
}


bool SpinBoxStyleOptions::hasOverride(StyleOverride mask) const
{
    return (_overrides & mask) != 0;
}


void SpinBoxStyleOptions::setOverride(StyleOverride mask)
{
    _overrides |= mask;
    ++_generation;
}
