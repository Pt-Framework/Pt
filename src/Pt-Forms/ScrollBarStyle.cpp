...
bool ScrollBarStyleOptions::hasOverrides() const
{
    return _overrides != 0;
}


std::size_t ScrollBarStyleOptions::generation() const
{
    return _generation;
}


bool ScrollBarStyleOptions::hasOverride(StyleOverride mask) const
{
    return (_overrides & mask) != 0;
}


void ScrollBarStyleOptions::setOverride(StyleOverride mask)
{
    _overrides |= mask;
    ++_generation;
}
