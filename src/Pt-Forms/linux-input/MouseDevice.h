...
#ifndef Pt_Forms_MouseDevice_h
#define Pt_Forms_MouseDevice_h
...
class MouseDevice : public System::Selectable
{
    public:
        MouseDevice(const char* deviceName);
    ...
    private:
        ...
        double _mouseResWidth;
        double _mouseResHeigh;
};
