...
bool ProgressBarStyleOptions::hasOverrides() const
{
    return _overrides != 0;
}


std::size_t ProgressBarStyleOptions::generation() const
{
    return _generation;
}


bool ProgressBarStyleOptions::hasOverride(StyleOverride mask) const
{
    return (_overrides & mask) != 0;
}


void ProgressBarStyleOptions::setOverride(StyleOverride mask)
{
    _overrides |= mask;
    ++_generation;
}
