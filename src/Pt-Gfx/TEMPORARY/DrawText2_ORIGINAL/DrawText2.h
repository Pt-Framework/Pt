...
class DrawText2 {
    public:
        ...
        void pathFromCharExt(std::vector<PointF>& points, std::vector<Pt::uint8_t>& tags, std::vector<Pt::int32_t>& contours, const Char& chr, Pt::int32_t& x, Pt::int32_t& y, const Char& chrNext);
