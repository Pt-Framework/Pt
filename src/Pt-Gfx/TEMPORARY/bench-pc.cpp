...
/*
    ...
    ---------------------------
         int8_t shl  =  0.084 uS (11.943 MIPS)
         int8_t shr  =  0.084 uS (11.939 MIPS)
         int8_t shlx =  0.586 uS ( 1.707 MIPS)
         int8_t shrx =  0.586 uS ( 1.707 MIPS)
         int8_t add  =  0.418 uS ( 2.390 MIPS)
         int8_t sub  =  0.418 uS ( 2.390 MIPS)
         int8_t mul  =  0.586 uS ( 1.706 MIPS)
         int8_t div  =  1.758 uS ( 0.569 MIPS)
        uint8_t shl  =  0.084 uS (11.949 MIPS)
        uint8_t shr  =  0.084 uS (11.952 MIPS)
        uint8_t shlx =  0.502 uS ( 1.991 MIPS)
        uint8_t shrx =  0.502 uS ( 1.992 MIPS)
        uint8_t add  =  0.418 uS ( 2.390 MIPS)
        uint8_t sub  =  0.419 uS ( 2.389 MIPS)
        uint8_t mul  =  0.586 uS ( 1.707 MIPS)
        uint8_t div  =  1.639 uS ( 0.610 MIPS)

        int16_t shl  =  0.084 uS (11.951 MIPS)
        int16_t shr  =  0.084 uS (11.946 MIPS)
