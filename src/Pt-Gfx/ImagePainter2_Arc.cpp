...
void ImagePainter2::fillArc( const PointF& topLeft, const SizeF& size, float degBegin, float degEnd, const ArcMode& arcMode )
{
    ...
    // Just for debugging
    drawArc(topLeft, size, degBegin, degEnd, arcMode);
}
