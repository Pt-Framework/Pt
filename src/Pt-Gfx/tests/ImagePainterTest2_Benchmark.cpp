...
static void doBenchmark(CompositionMode cm)
{
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_TEXT) {
        time1 = benchDrawText<ImagePainter2>(BENCHMARK_LOOP_COUNT, false, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_ROTATED_TEXT) {
        time1 = benchDrawText<ImagePainter2>(BENCHMARK_LOOP_COUNT, true, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_SOLID_LINE) {
        time1 = benchDrawSolidLine<ImagePainter2>(BENCHMARK_LOOP_COUNT, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_PATTERNED_LINE) {
        time1 = benchDrawPatternedLine<ImagePainter2>(BENCHMARK_LOOP_COUNT, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_SOLID_THICK_LINE) {
        time1 = benchDrawSolidThickLine<ImagePainter2>(BENCHMARK_LOOP_COUNT, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_PATTERNED_THICK_LINE) {
        time1 = benchDrawPatternedThickLine<ImagePainter2>(BENCHMARK_LOOP_COUNT, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_ELLIPSE) {
        time1 = benchDrawEllipse<ImagePainter2>(BENCHMARK_LOOP_COUNT, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_GRADIENT_FILLED_POLYGON) {
        time1 = benchDrawFillPolygon<ImagePainter2, false>(BENCHMARK_LOOP_COUNT, bmBrushGradientH, bmBrushGradientV, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_TEXTURE_FILLED_POLYGON) {
        time1 = benchDrawFillPolygon<ImagePainter2, false>(BENCHMARK_LOOP_COUNT, bmBrushTextureT, bmBrushTextureW, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_SOLID_FILLED_ELLIPSE) {
        time1 = benchDrawFillEllipse<ImagePainter2>(BENCHMARK_LOOP_COUNT, bmBrushSolid, bmBrushSolid, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_GRADIENT_FILLED_ELLIPSE) {
        time1 = benchDrawFillEllipse<ImagePainter2>(BENCHMARK_LOOP_COUNT, bmBrushGradientH, bmBrushGradientV, cm, AntiAliasingMode::None);
    ...
    if(BENCHMARK_RESULT_HTML || BENCHMARK_TEXTURE_FILLED_ELLIPSE) {
        time1 = benchDrawFillEllipse<ImagePainter2>(BENCHMARK_LOOP_COUNT, bmBrushTextureT, bmBrushTextureW, cm, AntiAliasingMode::None);
