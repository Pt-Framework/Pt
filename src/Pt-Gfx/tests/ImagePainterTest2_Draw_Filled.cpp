...
static void testDrawFillEllipse(const char* title, Image& image, Painter& painter, const Brush& brush1, const Brush& brush2)
{
    ...
    if(ip2) {
        ...
        ip2->drawArc( PointF (30 + 600, 50), SizeF(135, 135), 0, 135, ArcMode::Chord/*Pie*/ );
    ...
    if(ip2) {
        ...
        ip2->setAntiAliasingMode(AntiAliasingMode::Fastest);
        ip2->drawArc( PointF (30 + 600, 50 + 200), SizeF(135, 135), 120, 330, ArcMode::Chord/*Pie*/ );
    ...
    if(ip2) {
        ip2->setAntiAliasingMode(AntiAliasingMode::None);
        ip2->fillArc( PointF (30 + 400, 50 + 400), SizeF(135, 135), -150, 30, ArcMode::Chord/*Pie*/ );
        ip2->drawText( PointF(30 + 400, 30 + 400), "NOAA" );

        ip2->setAntiAliasingMode(AntiAliasingMode::Fastest);
        ip2->drawArc( PointF (30 + 600, 50 + 400), SizeF(135, 135), -150, 30, ArcMode::Chord/*Pie*/ );
    ...
    if(ip2) {
        ...
        ip2->setAntiAliasingMode(AntiAliasingMode::Fastest);
        ip2->drawArc( PointF (30 + 800, 50 + 400), SizeF(135, 135), 120, 240, ArcMode::Chord/*Pie*/ );
