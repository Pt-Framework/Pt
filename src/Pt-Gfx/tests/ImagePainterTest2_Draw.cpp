...
static void testDrawGradFillPolygon(const char* title, Image& image, Painter& painter)
{
    resetImage(image);
...
static void testDrawTxtrFillPolygon(const char* title, Image& image, Painter& painter)
{
    resetImage(image);
