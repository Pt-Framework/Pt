...
static void benchMatrixOps()
{
    ...
    */
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    :  2.149269 nS
    Time VD[] = M * VS[] :  1.262367 nS
    Time VS[] = M * VS[] :  1.510978 nS
    Time VS[] = M * VS[] :  3.423393 nS
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    :  1.486704 nS
    Time VD[] = M * VS[] :  1.284033 nS
    Time VS[] = M * VS[] :  1.248166 nS
    Time VS[] = M * VS[] :  1.325145 nS
