...
static void benchMatrixOps()
{
    ...
    Time M    = M * M    :  8.484140 nS
    Time VD[] = M * VS[] :  0.745341 nS
    Time VS[] = M * VS[] :  0.746623 nS
    Time VS[] = M * VS[] :  2.305210 nS
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    : 10.812253 nS
    Time VD[] = M * VS[] :  1.270518 nS
    Time VS[] = M * VS[] :  1.290888 nS
    Time VS[] = M * VS[] :  2.073929 nS
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    :  6.827250 nS
    Time VD[] = M * VS[] :  0.417948 nS
    Time VS[] = M * VS[] :  0.414282 nS
    Time VS[] = M * VS[] :  2.740964 nS
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    :  6.240889 nS
    Time VD[] = M * VS[] :  0.644684 nS
    Time VS[] = M * VS[] :  0.650540 nS
    Time VS[] = M * VS[] :  1.250118 nS
    */
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    : 37.260532 nS
    Time VD[] = M * VS[] :  9.639502 nS
    Time VS[] = M * VS[] :  9.919882 nS
    Time VS[] = M * VS[] : 20.619869 nS
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    : 53.897619 nS
    Time VD[] = M * VS[] :  9.920120 nS
    Time VS[] = M * VS[] :  9.989023 nS
    Time VS[] = M * VS[] : 17.286301 nS

    ---------------------------------------------------------
    With NEON (v7l; A53; BCM2709; RaspberryPi 3; 32-bit Mode)
    ---------------------------------------------------------
    */
}
