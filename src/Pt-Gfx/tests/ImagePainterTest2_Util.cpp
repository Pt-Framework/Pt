...
static void benchATransOps()
{
    ...
    Time M    = M * M    :  2.201330 nS
    Time VD[] = M * VS[] :  1.500398 nS
    Time VS[] = M * VS[] :  1.614064 nS
    Time VS[] = M * VS[] :  3.165573 nS
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    :  1.485795 nS
    Time VD[] = M * VS[] :  2.528295 nS
    ...
    */
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    : 10.704901 nS
    Time VD[] = M * VS[] : 18.864393 nS
    Time VS[] = M * VS[] : 24.446249 nS
    Time VS[] = M * VS[] : 40.589571 nS
    ...
    D: Point                  -> (18.500, 96.000)
    D: Point                  -> ( 7.500, 50.000)
    Time M    = M * M    :  8.566856 nS
    Time VD[] = M * VS[] : 19.299746 nS
    Time VS[] = M * VS[] : 19.697666 nS
    Time VS[] = M * VS[] : 21.363497 nS
