...
class PT_GFX_API ClipPolygon2
{
    public:
        ...
        */
        ...
        /** @brief Perform clipping
            ...
            @see ClipPolygon2::clip
        */
        void operator() (std::vector<Point>& in, const Rect& clippingArea )
        { ClipPolygon2::clip(in, clippingArea); }
    ...
    private:
        ...
        static bool inside( const Point& p,
                            const Point& edge0,
                            Point& edge1 );
};
