...
#ifndef PT_UI_FILLELLIPSE_H
#define PT_UI_FILLELLIPSE_H
...
class FillEllipse
{
    public:
        ...
        */
        void draw( Image& image, const Brush& brush, const PointF& topLeft, const SizeF& size );

    private:
        Fill* _fill;
        void outputSpan( Image& image, const Brush& brush, const PointF& topLeft, int x, int y, int width );
};
