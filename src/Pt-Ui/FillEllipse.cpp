...
void FillEllipse::outputSpan( Image& image, const Brush& brush, const PointF& topLeft, int x, int y, int width )
{
...
void FillEllipse::draw( Image& image, const Brush& brush, const PointF& topLeft, const SizeF& size )
{
