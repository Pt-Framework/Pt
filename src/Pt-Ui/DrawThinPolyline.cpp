...
void DrawThinPolyline::draw( Image& image, const Pen& pen, const PointF* points,  size_t pointCount )
{
    switch( pen.style() )
    {
        case Pen::SolidStyle:
...
void DrawThinPolyline::drawDash( Image& image, const Pen& pen, const PointF* points,  size_t pointCount)
{
    if (points <= 0)
        return;
...
void DrawThinPolyline::bresenhamDasheLineSegment(Image& image, const Pen& pen, int *pdashNum, int *pdashIndex, const unsigned int *pDash, int numInDashList, int *pdashOffset, bool isDoubleDash, int signdx, int signdy, int axis, int x1, int y1, int e, int e1, int e2, int len)
{
...
void DrawThinPolyline::drawSolid( Image& image, const Pen& pen, const PointF* points,  size_t pointCount)
{
    const PointF *ppt;
...
void DrawThinPolyline::bresenhamLineSegment(Image& image, const Pen& pen, int signdx, int signdy, int axis, int x1, int y1, int e, int e1, int e2, int len)
{
    if (len == 0)
        return;
