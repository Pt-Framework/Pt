...
void DrawWideDashPolyline::draw( Image& image, const Pen& pen, const PointF* pPts, size_t npt )
{
    int	      x1, y1, x2, y2;
...
void DrawWideDashPolyline::dashSegment( Image& image, const Pen& pen, int *pDashNum, int *pDashIndex, int *pDashOffset, int x1, int y1, int x2, int y2, bool projectLeft, bool projectRight, LineFace *leftFace, LineFace *rightFace, unsigned int* dash)
{
