...
void operator >>=(const SerializationInfo& si, Font& f)
{
    Pt::String fontName;
    size_t      fontSize;
    ssize_t     fontStyle;
    ...
    f = Font( fontName.narrow(), fontSize, (Font::FontStyle)fontStyle,
                   fontAngle, (Font::Direction)fontDirection );
}


void operator <<=(SerializationInfo& si, const Font& f)
{
    Pt::StringStream ss;
