...
void FillTexture::fill( Image& image, const Brush& brush,
                        const PointF& origin,
                        ssize_t xpos, ssize_t ypos, size_t length )
{
    const Image& texture = brush.texture();
...
void FillSolid::fill( Image& image, const Brush& brush,
                      const PointF& origin,
                      ssize_t xpos, ssize_t ypos, size_t length )
{
    const Image& texture = brush.texture();
