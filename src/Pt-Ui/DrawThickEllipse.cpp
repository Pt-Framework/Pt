...
void DrawThickEllipse::fillEllipse(  const PointF& topLeft, const SizeF& size )
{
...
void DrawThickEllipse::draw( Image& image, const Pen& pen, const PointF& topLeft, const SizeF& size )
{
