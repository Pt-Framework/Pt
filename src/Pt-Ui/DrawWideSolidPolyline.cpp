...
void DrawWideSolidPolyline::draw( Image& image, const Pen& pen,const PointF* pPts, size_t npt)
{
    int		   x1, y1, x2, y2;
...
void DrawWideSolidPolyline::drawSegment( Image& image, const Pen& pen, PointF from, PointF to, bool projectLeft, bool projectRight,
