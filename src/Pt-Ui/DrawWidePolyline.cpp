...
int DrawWidePolyline::polyBuildPoly( const PointF *vertices, const LineSlope *slopes, int count, int xi, int yi, LineEdge *left, LineEdge *right, int *pnleft, int *pnright, unsigned int *h)
{
    int	    top, bottom;
    double  miny, maxy;
    int     i;
...
void DrawWidePolyline::fillRect(Image& image,const Pen& pen, int x, int y, unsigned int w, unsigned int h)
{
...
void DrawWidePolyline::fillLine(Image& image, const Pen& pen, int y, unsigned int overall_height, LineEdge *left, LineEdge *right, int left_count, int right_count)
{
    int left_x		= 0;
    int left_e		= 0;
    int left_stepx	= 0;
...
void DrawWidePolyline::lineArc( Image& image, const Pen& pen, LineFace *leftFace, LineFace *rightFace, double xorg, double yorg, bool isInt)
{
...
int DrawWidePolyline::lineArcI (const Pen& pen, int xorg, int yorg, std::vector<PointF>& points, std::vector<size_t>& widths)
{
    PointF *tpts, *bpts;
    size_t* twids, *bwids;
    int x, y, e, ex;
...
int DrawWidePolyline::lineArcD( const Pen & pen, double xorg, double yorg, std::vector<PointF>& points, std::vector<size_t>& widths, LineEdge *edge1, int edgey1, bool edgeleft1, LineEdge *edge2, int edgey2, bool edgeleft2)
{
    PointF *pts;
    size_t *wids;
...
void DrawWidePolyline::lineJoin( Image& image, const Pen& pen, LineFace *pLeft, LineFace *pRight )
{
...
void DrawWidePolyline::lineProjectingCap( Image& image,const Pen& pen, const LineFace *face, bool isLeft, bool isInt )
{
    int		    xorgi = 0, yorgi = 0;
    int	       	lw;
