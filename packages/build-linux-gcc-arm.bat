...
-sLINKFLAGS="-Wl,-rpath-link,\"%LINARO_ARM_GNUABIHF_2014_04_R1%\arm-linux-gnueabihf\lib\" -Wl,-rpath-link,\"%LINARO_ARM_GNUABIHF_2013_11_R1%\arm-linux-gnueabihf\libarm-linux-gnueabihf\"" ^
--with-openssl 
